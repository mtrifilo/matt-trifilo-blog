...
This is the most important post of the whole series. You'll be learning new technologies and concepts for your whole career, so we may as well learn how learn effectively first. This will save you from many of the pitfalls I encountered on my own journey. This post will touch on many concepts that will not make sense if you're new to coding, but it will be helpful to become aware of them now, from the beginning, so you'll be able to come back to these references as soon as you need them. Don't be intimidated.
